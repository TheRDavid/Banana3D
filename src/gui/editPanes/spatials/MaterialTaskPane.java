...
public class MaterialTaskPane extends EditTaskPane
{
     ...
     * @param assetName
     */
    public MaterialTaskPane(String assetName)
    {
    ...
    public void updateMaterial()
    {
        CurrentData.getEditorWindow().getB3DApp().enqueue(new Callable<Integer>()
        {
            ...
            {
                Geometry g = (Geometry) CurrentData.getEditorWindow().getB3DApp().getSelectedObject();
                ...
                B3D_Geometry element = (B3D_Geometry) Wizard.getObjects().getB3D_Element(elementUUID);
