...
public enum Preference implements Serializable
{
    ...
    RECENT_PROJECT_PATHS, EXIT_WITHOUT_PROMPT, FULLSCREEN, ASSETBROWSER_SHOWN, SHOW_GRID, SHOW_SCENERY, SHOW_FILTERS,
    ...
    COLOR_DEPTH, MULTISAMPLING, DEPTH_BITS, FIELD_OF_VIEW;
}
